...
namespace Alexsaab\Tests\Shoppingcart;

use Mockery;
use PHPUnit\Framework\Assert;
use Alexsaab\Shoppingcart\Cart;
use Orchestra\Testbench\TestCase;
use Illuminate\Auth\Events\Logout;
use Illuminate\Support\Collection;
use Alexsaab\Shoppingcart\CartItem;
use Illuminate\Support\Facades\Event;
use Illuminate\Session\SessionManager;
use Illuminate\Contracts\Auth\Authenticatable;
use Alexsaab\Shoppingcart\ShoppingcartServiceProvider;
use Alexsaab\Tests\Shoppingcart\Fixtures\ProductModel;
use Alexsaab\Tests\Shoppingcart\Fixtures\BuyableProduct;
...
class CartTest extends TestCase
{
    ...
    /**
     * @test
     * @expectedException \Alexsaab\Shoppingcart\Exceptions\InvalidRowIDException
     */
    ...
    /**
     * @test
     * @expectedException \Alexsaab\Shoppingcart\Exceptions\UnknownModelException
    ...
    /**
     * @test
     * @expectedException \Alexsaab\Shoppingcart\Exceptions\CartAlreadyStoredException
     ...
     *
     * @return \Alexsaab\Shoppingcart\Cart
     */
